...
class TestDraftFilter(unittest.TestCase):
    ...
    def test_only_drafts_filter(
        ...
        result, _ = fetch_and_process_pull_requests(
            "owner", "repo", draft_filter="only-drafts"
        )
    ...
    def test_no_drafts_filter(
        ...
        result, _ = fetch_and_process_pull_requests(
            "owner", "repo", draft_filter="no-drafts"
        )
