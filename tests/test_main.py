...
class TestMainFunction(unittest.TestCase):
    ...
    def test_main(self, mock_parse_arguments, mock_print_timestamp, mock_print_markdown_output, mock_generate_markdown_output, mock_fetch_and_process_pull_requests):
